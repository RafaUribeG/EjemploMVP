...
public class FragRegistroEquipo extends Fragment implements RegistroEquipoView {
    ...
    public void exitoEquipo() {
        ...
        txtModelo.setText("");
        txtObs.setText("");
        rdNoCargador.setChecked(true);
        rdNoEquipo.setChecked(true);
        rdNoManual.setChecked(true);
        rdNoGarantia.setChecked(true);
        rdNoSistemaOp.setChecked(true);
        rdNoMonitor.setChecked(true);
        rdNoAudio.setChecked(true);
        rdNoTouchpad.setChecked(true);
    }
